                ...
                <View style={[styles.routeInfo, { flexDirection: 'column' }]}>
                    <View style={[styles.routeNode, { flexDirection }]}>
                        ...
                        <Text
                            variant="body"
                            weight="bold"
                            style={[styles.addressText, { textAlign, color: colors.textPrimary }]}
                            numberOfLines={2}
                            ellipsizeMode="tail"
                        >
                            {pickupAddress || t('currentLocation')}
                        </Text>
                    </View>
                ...
                >
                    {ridesData.map((ride) => (
                        ...
                        >
                            ...
                            {/* Icon Section */}
                            <View style={[styles.rideIconWrapper, isRTL ? { marginLeft: 10 } : { marginRight: 10 }]}>
                                <Image
                                    source={ride.image}
                            ...
                            <View style={[styles.rideInfo, { alignItems: isRTL ? 'flex-end' : 'flex-start' }]}>
                                <View style={{ flexDirection: flexDirection, alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
                                    <Text
                                        variant="body"
                                        weight="bold"
                                ...
                                <Text variant="caption" style={{ color: colors.textSecondary, marginTop: 2 }} numberOfLines={1}>{ride.eta}</Text>
                                {ride.promo && (
                                    <View style={[styles.promoTag, { backgroundColor: isDark ? 'rgba(6, 78, 59, 0.7)' : '#DCFCE7' }]}>
                                        <Text variant="caption" weight="bold" style={{ color: isDark ? '#34D399' : '#166534', fontSize: 11 }} numberOfLines={1}>{ride.promo}</Text>
                                    </View>
                                )}
                            </View>
                            ...
                            <View style={[styles.priceSection, { alignItems: isRTL ? 'flex-start' : 'flex-end' }]}>
                                <View style={{ flexDirection: flexDirection, alignItems: 'baseline', flexWrap: 'nowrap' }}>
                                    <Text variant="caption" weight="bold" style={{ color: colors.textPrimary, marginRight: isRTL ? 0 : 2, marginLeft: isRTL ? 2 : 0, fontSize: 12 }} numberOfLines={1}>{t('currency') || 'EGP'}</Text>
                                    <Text variant="h3" style={{ color: colors.textPrimary }} numberOfLines={1}>{ride.price.toFixed(2)}</Text>
                                </View>
                                {ride.oldPrice && (
                                    <Text variant="caption" style={{ color: colors.textMuted, textDecorationLine: 'line-through' }} numberOfLines={1}>{t('currency') || 'EGP'} {ride.oldPrice.toFixed(2)}</Text>
                                )}
                            </View>
                        </TouchableOpacity>
                    ))}
