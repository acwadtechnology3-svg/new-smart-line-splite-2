...
const envSchema = z.object({
  ...
  LOG_REDACT: z.string().default('true').transform((val) => val === 'true'),
  SLOW_REQUEST_MS: z.string().default('800').transform((val) => parseInt(val, 10)),
  SERVICE_NAME: z.string().default('smartline-backend'),
  ...
  KASHIER_SECRET_KEY: z.string().min(1, 'KASHIER_SECRET_KEY is required'),
